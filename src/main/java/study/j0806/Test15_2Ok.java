...
@WebServlet("/j0806/Test15_2Ok")
public class Test15_2Ok extends HttpServlet{
	@Override
		...
		Test15VO vo = new Test15VO(name, hakbun, kor, eng, mat, sci, soc, tot, avg, grade, hostIp);
		
		request.setAttribute("vo", vo);
		String viewPage = "/study/0806/test15_res.jsp";

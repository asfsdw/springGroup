...
<body>
	...
	<div class="container">
		...
		<p><br/></p>
		<form name="myform" method="post" action="GuestInputOk.guest" class="was-validated">
	    ...
	    <div class="form-group text-center">
	    	...
	    	<button type="button" onclick="location.href='GuestList.guest';" class="btn btn-danger">돌아가기</button>
	    </div>

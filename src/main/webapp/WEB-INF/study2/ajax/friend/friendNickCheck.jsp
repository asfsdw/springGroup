...
<head>
  ...
  <title>loginNickCheck.jsp</title>
...
<div class="container text-center">
  ...
  <c:if test="${res != 1}">
    ...
    <form name="childForm" method="post" action="${ctp}/study2/ajax/friend/FriendNickCheck">
    	<div class="input-group mt-3">
    	  <input type="text" name="nickName" class="form-control" autofocus required />
    	  <input type="button" value="닉네임재검색" onclick="nickCheck()" class="btn btn-secondary btn-sm"/>
    	</div>
    </form>
  </c:if>
</div>

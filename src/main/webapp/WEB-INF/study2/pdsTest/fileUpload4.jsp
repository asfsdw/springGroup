...
<html>
	<head>
		...
		<title>파일 업로드 4번(COS라이브러리)</title>
		<script>
		 'use strict';
		 
		 function fCheck() {
			 let fName = $("#file")[0].files;
			 let maxSize = 1024 * 1024 * 10; // 2바이트^10=1024바이트 *2=메가바이트
			 
			 let ext = "";
			 for(let i=0; i<fName.length; i++) {
				 ext = fName[i].substring(fName[i].lastIndexOf(".")+1).toLowerCase()+"/";
			 }
...
<body>
	...
	<div class="container">
		...
		<p><br/></p>
		<form name="myform" method="post" action="FileUploadOk4.study" enctype="multipart/form-data">
			<div class="input-group">
				<input type="file" name="fName" id="file" multiple class="form-control" />

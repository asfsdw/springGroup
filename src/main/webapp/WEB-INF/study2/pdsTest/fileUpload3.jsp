...
<html>
	<head>
		...
		<title>파일 업로드 3번(COS라이브러리)</title>
		<script>
		 'use strict';
...
<body>
	...
	<div class="container">
		...
		<p><br/></p>
		<form name="myform" method="post" action="FileUploadOk3.study" enctype="multipart/form-data">
			<div>
				<input type="button" value="파일박스 추가" onclick="fileBoxAppend()" class="btn btn-primary" /> <br/>
				<p></p>
				<input type="file" name="fName1" id="file1" class="form-control" />
			</div>
			<p></p>
			<div id="fileBox"></div>
			<p></p>
